  ...
  return (
    <section className="flex flex-col items-center">
      <div className="flex max-w-xl flex-col items-center pb-16 pt-8 text-center lg:pb-48 lg:pt-32">
        <p className="mb-4 font-semibold text-indigo-500 md:mb-6 md:text-lg xl:text-xl">Transformin Learning with AI Assistance</p>

        <h1 className="mb-8 text-4xl font-bold text-black sm:text-5xl md:mb-12 md:text-6xl">A New Era for Interactive Education</h1>

        <form className="flex gap-2 text-black w-full" onSubmit={onSubmit}>
          <div className="text-black w-full">
            <input type="text" placeholder="Search for learning recources, tutorials..."
              className="border-2 border-gray-300 px-2 py-1 w-full rounded-lg" />
          </div>

          <input type="submit" value="Search" className="bg-indigo-500 text-white px-4 rounded-lg hover:bg-indigo-400" />
        </form>
